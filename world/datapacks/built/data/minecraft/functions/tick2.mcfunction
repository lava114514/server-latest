...
execute as @e[type=zombie,tag=Huixue1] at @s unless entity @e[type=zombie,tag=Huixue2,distance=0..10] run fill ~ ~ ~-1 ~ ~ ~1 air replace damaged_anvil
execute as @e[type=zombie,tag=Huixue1] at @s unless entity @e[type=zombie,tag=Huixue2,distance=0..10] run fill ~-1 ~1 ~ ~1 ~6 ~ air replace chain
execute as @e[type=zombie,tag=Huixue1] at @s unless entity @e[type=zombie,tag=Huixue2,distance=0..10] run fill ~ ~1 ~-1 ~ ~6 ~1 air replace chain
